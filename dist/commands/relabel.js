...
export function registerRelabelCommand(program) {
    program
        .command('relabel')
        ...
        if (!hasSession(sessionName)) {
            throw new TmuxError(ErrorCode.TMUX_SESSION_NOT_FOUND, `Session '${sessionName}' is not running.`, { recoveryHint: "Run 'handoff attach' or start a new workspace with 'handoff start'." });
        }
