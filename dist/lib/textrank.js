 ...
 */
export function buildSimilarityGraph(sentences) {
 ...
 */
function runPageRank(graph, config) {
 ...
 */
export function textRank(sentences, config) {
 ...
 */
export function summarize(text, config) {
    const cfg = { ...DEFAULT_CONFIG, ...config };
 ...
 */
export function summarizeDiff(diff, maxSentences = 20) {
    if (!diff.trim())
        return diff;
    ...
    if (changedLines.length <= maxSentences)
        return diff;
...
//# sourceMappingURL=textrank.js.map