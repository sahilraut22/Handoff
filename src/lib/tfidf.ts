 ...
 */
export function buildCorpus(documents: string[]): TfIdfCorpus {
 ...
 */
export function computeTfIdf(document: string, corpus: TfIdfCorpus): TfIdfVector {
...
export function rankByRelevance(
  ...
  documents: string[],
  labels?: string[]
): Array<{ label: string; score: number; index: number }> {
