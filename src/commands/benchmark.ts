...
import type { FileChange, HandoffContext, Decision } from '../types/index.js';

function makeSyntheticChanges(n: number): FileChange[] {
...
export function registerBenchmarkCommand(program: Command): void {
  program
    ...
    .action(async (options: { iterations: string; json?: boolean; filter?: string }) => {
